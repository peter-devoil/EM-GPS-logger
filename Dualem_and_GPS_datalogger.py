...
class EMApp(ttk.Frame):
    ...
    def initUI(self):
        ...
        PRP0Ent.grid(row=2, column = 1, pady=5)

        self.PRP1Lab = ttk.Label(self.frame3, text="PRP1") 
        self.PRP1Lab.grid(row=2, column = 2, pady=5)
        ...
        PRP1Ent.grid(row=2, column = 3, pady=5)

        self.PRP2Lab = ttk.Label(self.frame3, text="PRP2") 
        self.PRP2Lab.grid(row=2, column = 4, pady=5)
        ...
        PRP2Ent.grid(row=2, column = 5, pady=5)

        self.HCP0Lab = ttk.Label(self.frame3, text="HCP0") 
        self.HCP0Lab.grid(row=3, column = 0, pady=5)
        ...
        HCP0Ent.grid(row=3, column = 1, pady=5)

        self.HCP1Lab = ttk.Label(self.frame3, text="HCP1") 
        self.HCP1Lab.grid(row=3, column = 2, pady=5)
        ...
        HCP1Ent.grid(row=3, column = 3, pady=5)

        self.HCP2Lab = ttk.Label(self.frame3, text="HCP2") 
        self.HCP2Lab.grid(row=3, column = 4, pady=5)
...
#                config['GPS1']['Address'] = currentBTNames[0]
    ...
    def doit(self):
        ...
        self.recordEM(self.EM_PRP0Val.get(),self.EM_PRP1Val.get(), self.EM_PRP2Val.get(), 
                      self.EM_HCP0Val.get(),self.EM_HCP1Val.get(), self.EM_HCP2Val.get())
    ...
    def doitPlot(self):
        ...
        self.recordEM(self.EM_PRP0Val.get(), self.EM_PRP1Val.get(), self.EM_PRP2Val.get(), 
                      self.EM_HCP0Val.get(), self.EM_HCP1Val.get(), self.EM_HCP2Val.get(), forceRedraw = True)
    ...
    # record an EM sample
    def recordEM(self, EM_PRP0Val, EM_PRP1Val, EM_PRP2Val, EM_HCP0Val, EM_HCP1Val, EM_HCP2Val, forceRedraw = False):
